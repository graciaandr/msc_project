...
p = ggplot2::ggplot(data = df, aes(x = ALGO,
                                   y = CTRLvsCIN2Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=CTRLvsCIN2Plus), vjust=1.6, color="white", size=12) +
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_CTRLvsCIN2Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_CTRLvsCIN2Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
...
p = ggplot2::ggplot(data = df, aes(x = ALGO,
                                   y = CTRLvsCIN2)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=CTRLvsCIN2), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18),
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_CTRLvsCIN2)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_CTRLvsCIN2), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") +
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = CTRLvsCIN3Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=CTRLvsCIN3Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_CTRLvsCIN3Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_CTRLvsCIN3Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = negCTRLvsCIN2Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=negCTRLvsCIN2Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_negCTRLvsCIN2Plus)) +
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_negCTRLvsCIN2Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = negCTRLvsCIN2)) + 
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=negCTRLvsCIN2), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") +
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_negCTRLvsCIN2)) + 
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_negCTRLvsCIN2), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = negCTRLvsCIN3Plus)) + 
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=negCTRLvsCIN3Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
...
p = ggplot2::ggplot(data = df, aes(x = ALGO, y = FS_negCTRLvsCIN3Plus)) + 
  geom_bar(stat="identity", color = df$color, fill = df$color, alpha = 0.75) +
  geom_text(aes(label=FS_negCTRLvsCIN3Plus), vjust=1.6, color="white", size=12) +
  theme_minimal() + theme(axis.title.x = element_text(size = 20),
                          axis.text.x = element_text(size = 18),
                          axis.title.y = element_text(size = 20),
                          axis.text.y = element_text(size = 18), legend.position="none") + xlab("ML Model") + 
