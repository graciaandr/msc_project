...
calcdiffmeth <- readRDS("artistic_trial/calculateDiffMeth_object_negCTRLvsCIN2.rds")
...
meth = readRDS("artistic_trial/df_meth_negCTRLvsCIN2.rds")
print(head(meth, 5))
...
saveRDS(df_beta_vals_filt_10, file = "classifying_data/negCTRLvsCIN2_artistic_study_betas_b4_EDMR_10threshold.rds")
saveRDS(df_beta_vals_filt_25, file = "classifying_data/negCTRLvsCIN2_artistic_study_betas_b4_EDMR_25threshold.rds")
saveRDS(df_beta_vals_filt_50, file = "classifying_data/negCTRLvsCIN2_artistic_study_betas_b4_EDMR_50threshold.rds")
...
saveRDS(calcdiffmeth2_10, file = "classifying_data/negCTRLvsCIN2_calcdiffmeth2_10.rds")

calcdiffmeth2_25$qvalue = p.adjust(calcdiffmeth2_25$pvalue, method = "BH")
saveRDS(calcdiffmeth2_25, file = "classifying_data/negCTRLvsCIN2_calcdiffmeth2_25.rds")

calcdiffmeth2_50$qvalue = p.adjust(calcdiffmeth2_50$pvalue, method = "BH")
saveRDS(calcdiffmeth2_50, file = "classifying_data/negCTRLvsCIN2_calcdiffmeth2_50.rds")
...
saveRDS(df_DMPs_10, file = "classifying_data/negCTRLvsCIN2_df_DMPs_10.rds")

write.table(df_DMPs_25,
            file = "classifying_data/df_DMPs_25",
            col.names = TRUE, sep = ";", row.names = TRUE)
saveRDS(df_DMPs_25, file = "classifying_data/negCTRLvsCIN2_df_DMPs_25.rds")

write.table(df_DMPs_50,
            file = "classifying_data/df_DMPs_50.txt",
            col.names = TRUE, sep = ";", row.names = TRUE)
saveRDS(df_DMPs_50, file = "classifying_data/negCTRLvsCIN2_df_DMPs_50.rds")
...
write.table(df_beta_vals_filtered_10,
            file = "classifying_data/negCTRLvsCIN2_artistic_study_filt-beta-values_0722_10threshold.txt",
            col.names = TRUE, sep = ";", row.names = TRUE)
write.table(df_beta_vals_filtered_25,
            file = "classifying_data/negCTRLvsCIN2_artistic_study_filt-beta-values_0722_25threshold.txt",
            col.names = TRUE, sep = ";", row.names = TRUE)
write.table(df_beta_vals_filtered_50,
            file = "classifying_data/negCTRLvsCIN2_artistic_study_filt-beta-values_0722_50threshold.txt",
            col.names = TRUE, sep = ";", row.names = TRUE)

saveRDS(df_beta_vals_filtered_10, file = "classifying_data/negCTRLvsCIN2_df_beta_vals_filtered_10.rds")
saveRDS(df_beta_vals_filtered_25, file = "classifying_data/negCTRLvsCIN2_df_beta_vals_filtered_25.rds")
saveRDS(df_beta_vals_filtered_50, file = "classifying_data/negCTRLvsCIN2_df_beta_vals_filtered_50.rds")
