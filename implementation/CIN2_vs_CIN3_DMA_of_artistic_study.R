...
print(nrow(metadata))
metadata = metadata[ (metadata$Histology == "CIN 3" | metadata$Histology == "CIN 3/Ca in situ" | metadata$Histology == "CIN 2" ),]
print(nrow(metadata))
...
list_of_files = as.list(paste0(path, metadata$path2))
...
saveRDS(meth, file = "/data/home/bt211038/msc_project/artistic_trial/df_meth_CIN2vsCIN3.rds")
...
saveRDS(myDiff, file = "/data/home/bt211038/msc_project/artistic_trial/calculateDiffMeth_object_CIN2vsCIN3.rds")
# myDiff
...
saveRDS(df_beta_vals, file = "/data/home/bt211038/msc_project/classifying_data/artistic_study_initial_beta_values_CIN2vsCIN3.rds")
